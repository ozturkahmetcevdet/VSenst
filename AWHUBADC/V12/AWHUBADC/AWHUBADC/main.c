...
QTOUCHADC_REFERANCE_FILTER QTOUCHADC_REFERANCE_FILTER_P[2] = {{.Activity = true, .LoopCycle = SAMPLE_COUNT, .AlphaDivider = 2, .AlphaMultiplier = 3, .CounterLimit = 3, .FilterValue = 10, .NegativeThreshold = -30, .Calibrate = true, .SenseCalibrate = true, .MaxRawValue = 0},
															  {.Activity = true, .LoopCycle = SAMPLE_COUNT, .AlphaDivider = 2, .AlphaMultiplier = 3, .CounterLimit = 3, .FilterValue = 10, .NegativeThreshold = -30, .Calibrate = true, .SenseCalibrate = true, .MaxRawValue = 0}};
//ATtiny817
