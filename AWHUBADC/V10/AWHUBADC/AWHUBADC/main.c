...
#if B_STYLE == (1)
uint8_t Const_In_PSD1 = 0, Const_In_PSD2 = 0;
#endif
...
QTOUCHADC_REFERANCE_FILTER QTOUCHADC_REFERANCE_FILTER_P[2] = {{.AlphaDivider = 2, .AlphaMultiplier = 3, .CounterLimit = 3, .FilterValue = 10, .NegativeThreshold = -30, .Calibrate = true},
															  {.AlphaDivider = 2, .AlphaMultiplier = 3, .CounterLimit = 3, .FilterValue = 10, .NegativeThreshold = -30, .Calibrate = true}};
//ATtiny817
...
#define GET_PERIODIC_TIMER_VALUE(x) (x + 0x07) << 1 //@ 0x08 --> 512ms start address
enum{
	T_256  = 0,
	T_2048 = 3
	};
