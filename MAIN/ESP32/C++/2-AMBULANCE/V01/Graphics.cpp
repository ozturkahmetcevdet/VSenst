...
void Graphics::Loop(bool enable)
{
  ...
  {
    this->SetBitmap(this->BELT_PositionXY[j][0], this->BELT_PositionXY[j][1], this->BELT_Width, this->BELT_Height, this->BELT_NameList[this->BELT_CurrentImage[j] - 1], this->BELT_ImageProcess[j]);
  }
