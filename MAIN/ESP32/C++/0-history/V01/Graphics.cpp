...
void Graphics::Loop(bool enable)
{
  /*if(touch.touched())
  {
    this->rawLocation = touch.getPoint();
    Serial.print("x = ");
    Serial.print(this->rawLocation.x);
    Serial.print(", y = ");
    Serial.print(this->rawLocation.y);
    Serial.print(", z = ");
    Serial.println(this->rawLocation.z); 
  }
  else
  {
  ...
  //this->SetBitmap(this->DOOR_PositionXY[0], this->DOOR_PositionXY[1], this->DOOR_Width, this->DOOR_Height, this->DOOR_NameList[this->DOOR_CurrentImage - 1], this->DOOR_ImageProcess);

  /*this->SetBitmap(this->PAGE_PositionXY[0], this->PAGE_PositionXY[1], this->PAGE_Width, this->PAGE_Height, this->PAGE_NameList[0], true);
  delay(100);
  this->SetBitmap(this->PAGE_PositionXY[0], this->PAGE_PositionXY[1], this->PAGE_Width, this->PAGE_Height, this->PAGE_NameList[1], true);
  delay(100);*/
}
