...
class PwnLookup(object):
    ...
    def __init__(self, spi1, spi2, dc=4, cs1=16, rst=17, blght=32, cs2=5, rotation=270):
        """Initialize PwnLookup."""
        # Set up display
        self.display = Display(spi1, dc=Pin(dc), cs=Pin(cs1), rst=Pin(rst), blght=Pin(blght),
...
def main():
    """Start PwnLookup."""
    spi1 = SPI(1, baudrate=24000000,
               sck=Pin(0), mosi=Pin(13), miso=Pin(12))
    spi2 = SPI(2, baudrate=24000000,
               sck=Pin(18), mosi=Pin(23), miso=Pin(19))

    PwnLookup(spi1, spi2, dc=2, cs1=15, rst=4, blght=32, cs2=16)
