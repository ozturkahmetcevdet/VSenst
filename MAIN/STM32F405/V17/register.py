    ...
    def Process(self, fullData=[]):
        ...
        for item in self.SensorList:
            if item.Prox2_SeatHasSensor == True:
                ...
                debugLog += "{tc0}{0:2}-{tc1} ID:{id_c1}{1:3}{id_c2}, Sensor Resolation:{re_c1}{2:4}{re_c2}, Sensor Cable:{se_c1}{3:1}{se_c2}, Seat Belt:{be_c1}{4:1}{be_c2}, Count:{co_c1}{5:4}{co_c2}, Direction:{di_c1}{6:4}{di_c2} --> RF Received Data Count:{rf_c1}{7:6}{rf_c2}\n\r"     \
                            .format(itemCount, binascii.hexlify(item.ID), item.Prox2_CurrentResolation, item.Prox2_IsSeatActive, item.Prox2_IsSeatHasBelt, item.Prox2_Count, directionStringValue, item.InComingDataCount                             \
            ...
            if item.Prox1_SeatHasSensor == True:
                ...
                debugLog += "{tc0}{0:2}-{tc1} ID:{id_c1}{1:3}{id_c2}, Sensor Resolation:{re_c1}{2:4}{re_c2}, Sensor Cable:{se_c1}{3:1}{se_c2}, Seat Belt:{be_c1}{4:1}{be_c2}, Count:{co_c1}{5:4}{co_c2}, Direction:{di_c1}{6:4}{di_c2} --> RF Received Data Count:{rf_c1}{7:6}{rf_c2}\n\r"     \
                            .format(itemCount, binascii.hexlify(item.ID), item.Prox1_CurrentResolation, item.Prox1_IsSeatActive, item.Prox1_IsSeatHasBelt, item.Prox1_Count, directionStringValue, item.InComingDataCount                             \
                                                , tc0   = TextColour.BOLD + TextColour.OKCYAN                                         , tc1   = TextColour.ENDC                          \
                                                , id_c1 = TextColour.OKBLUE                                                           , id_c2 = TextColour.ENDC                          \
