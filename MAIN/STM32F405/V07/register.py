...
class Sensor():
    ...
    def DataIn(self, data=bytearray(16)):
        ...
        Prox1ResolationCurrentValue = data[self.Prox1_ResolationAddressInArray + 1] | (data[self.Prox1_ResolationAddressInArray] << 8)
        Prox2ResolationCurrentValue = data[self.Prox2_ResolationAddressInArray + 1] | (data[self.Prox2_ResolationAddressInArray] << 8)
        ...
        if p1Res != 0 and p1Res > p2Res:
            ...
            if p2Res != 0:
                ...
                if value > Proximity.Default.constVal:
                    ...
                    if value > Proximity.Default.constVal:
                        self.Prox1_Threshold = p1Res - (value / Proximity.Default.thresholdDivider)
            ...
            if p1Res != 0:
                ...
                if value > Proximity.Default.constVal:
                    value -= Proximity.Default.constVal
                    if value > Proximity.Default.constVal:
                        self.Prox2_Threshold = p2Res - (value / Proximity.Default.thresholdDivider)
