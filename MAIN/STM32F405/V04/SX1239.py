...
class SX1239():
    ...
    def Receive(self):
        ...
        if TempRFState is RF_STOP:
            ...
            self.Buffer.Value[self.Buffer.Size] = self.Read(0x00, 16)
            self.Buffer.Size += 1
            self.RFState = RF_BUSY
    ...
    def ReadBuffer(self):
        buff = self.Buffer.Value[self.Buffer.Size - 1]
        self.Buffer.Value[self.Buffer.Size - 1] = bytearray(16)
        self.Buffer.Size -= 1
        return buff
