...
class Display():
    ...
    def SocialDistance(self):
        if NextionCommand.SocialDistance.Buffer is not NextionCommand.SocialDistance.Backup:
    ...
    def Instructions(self):
        if NextionCommand.Instructions.Buffer is not NextionCommand.Instructions.Backup:
