...
class SX1239():
    ...
    def Setup(self):
        ...
        while (self.Read(0x0A, 1)[0] & 0x40) == 0:
            pass
        self.Write(0x0A, self.Read(0x0A, 1)[0] | 0x80)
        while (self.Read(0x0A, 1)[0] & 0x40) == 0:
            pass
    ...
    def SetRfMode(self, mode=RF_STANDBY):
        ...
        while (self.Read(0x27, 1)[0] & 0b10000000) == 0:
            pass
        return 1
    ...
    def Receive(self):
        ...
        if TempRFState == RF_STOP:
            ...
            self.Buffer.Value.append(self.Read(0x00, 16))
            self.Buffer.Size += 1
            self.RFState = RF_BUSY
