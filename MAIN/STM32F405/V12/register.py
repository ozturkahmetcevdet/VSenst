...
class Sensor():
    ...
    def DataIn(self, data=bytearray(16)):
        ...
        self.BatteryMeasurement = (data[10] & 0xF0 | (data[11] & 0xF0) >> 4) + 9
        print(self.BatteryMeasurement * 2.5 / 255 * 2)
        ...
        print("p1Resolation:{}, p2Resolation:{}\n".format(self.Prox1_CurrentResolation, self.Prox2_CurrentResolation))
        return True
        ...
        if p1Res > p2Res and p1Res > Proximity.Default.Threshold:
            if p2Res != 0:
                ...
                if value > Proximity.Default.constVal:
                    value = p1Res - (value / Proximity.Default.thresholdDivider)
            ...
            if p1Res != 0:
                ...
                value = p2Res - p1Res
                if value > Proximity.Default.constVal:
                    value = p2Res - (value / Proximity.Default.thresholdDivider)
