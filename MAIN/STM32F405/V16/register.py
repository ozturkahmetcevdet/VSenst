    ...
    def Process(self, fullData=[]):
        ...
        for item in self.SensorList:
            if item.Prox1_SeatHasSensor == True:
                itemCount += 1
                debugLog += "{tc0}{0:2}-{tc1} ID:{id_c1}{1:3}{id_c2}, Sensor Resolation:{re_c1}{2:4}{re_c2}, Sensor Cable:{se_c1}{3:1}{se_c2}, Seat Belt:{be_c1}{4:1}{be_c2}, Count:{co_c1}{5:4}{co_c2} --> RF Received Data Count:{rf_c1}{6:6}{rf_c2}\n\r"     \
