...
class NextionCommand:
    ...
    def ClearAllBuffer(self):
        ...
        NextionCommand.ProgressBar.ClearBuffer(NextionCommand.ProgressBar)
...
class Display():
    ...
    def Setup(self):
        ...
        self.UART = UART(3, 921600) #921600
    ...
    def ProgressBar(self):
        if (NextionCommand.ProgressBar.Buffer != NextionCommand.ProgressBar.Backup) or NextionCommand.ProgressBar.Repeat:
            self.SendCommand(NextionCommand.ProgressBar.Headline + NextionCommand.ProgressBar.Buffer)
            NextionCommand.ProgressBar.Backup = NextionCommand.ProgressBar.Buffer
