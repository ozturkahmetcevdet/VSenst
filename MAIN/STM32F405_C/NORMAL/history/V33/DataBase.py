            ...
            if self.HubList != []:
                for item in self.HubList:
                    ...
                    if item.features[key.hub.px1]:
                        debugLog += "{tc0}{0:2}-{tc1} ID:{id_c1}{1:3}{id_c2}, PxV:{re_c1}{2:5}{re_c2}, PxBV:{rv_c1}{3:5}{rv_c2}, Px Cable:{se_c1}{4}{se_c2}, Seatbelt:{be_c1}{5}{be_c2}, Calibration:{ca_c1}{6}{ca_c2}, Count:{co_c1}{7:4}{co_c2} --> RF Count:{rf_c1}{8:6}{rf_c2}, RSSI:{rs_c1}{9:4}dBm{rs_c2}, CRCErr:{cc_c1}{10:6}{cc_c2}, Battery:{bt_c1}%{11:3}{bt_c2}"     \
                    ...
                    if item.features[key.hub.px2]:
                        debugLog += "\n\r{tc0}{0:2}-{tc1} ID:{id_c1}{1:3}{id_c2}, PxV:{re_c1}{2:5}{re_c2}, PxBV:{rv_c1}{3:5}{rv_c2}, Px Cable:{se_c1}{4}{se_c2}, Seatbelt:{be_c1}{5}{be_c2}, Calibration:{ca_c1}{6}{ca_c2}, Count:{co_c1}{7:4}{co_c2} --> RF Count:{rf_c1}{8:6}{rf_c2}, RSSI:{rs_c1}{9:4}dBm{rs_c2}, CRCErr:{cc_c1}{10:6}{cc_c2}, Battery:{bt_c1}%{11:3}{bt_c2}"     \
