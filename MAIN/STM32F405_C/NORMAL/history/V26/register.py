...
class Sensor():
    ...
    def DataIn(self, data=bytearray(RF_DATA_SIZE)):
        ...
        Prox1ResolationCurrentValue = 0 if self.Prox1_IsSeatActive == False else (data[self.Prox1_ResolationAddressInArray + 1] | (data[self.Prox1_ResolationAddressInArray] << 8)) << 1
        Prox2ResolationCurrentValue = 0 if self.Prox2_IsSeatActive == False else (data[self.Prox2_ResolationAddressInArray + 1] | (data[self.Prox2_ResolationAddressInArray] << 8)) << 1
